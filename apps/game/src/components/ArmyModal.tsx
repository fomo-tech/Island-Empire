...
const ShieldCrestSVG = () => {
  ...
  return (
    ...
    >
      <path
        d="M32 4C18 8 10 18 10 34c0 16 14 24 22 28 8-4 22-12 22-28 0-16-8-26-22-30z"
        fill="#991b1b"
        stroke="#ca8a04"
        strokeWidth="2.5"
      />
...
const CastleIconSVG = () => {
  ...
  return (
    <svg viewBox="0 0 64 64" width="22" height="22" style={{ flexShrink: 0 }}>
      <path
        d="M12 20h8v8h8v-8h8v8h8v-8h8v36H12z"
        fill="#cbd5e1"
        stroke="#334155"
        strokeWidth="2.5"
      />
...
const CityIconSVG = () => {
  ...
  return (
    <svg viewBox="0 0 64 64" width="22" height="22" style={{ flexShrink: 0 }}>
      <path
        d="M8 24h14v32H8zm17-10h14v42H25zm17 14h14v28H42z"
        fill="#94a3b8"
        stroke="#334155"
        strokeWidth="2"
      />
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        width="22"
        height="50"
        fill="url(#wallGradCastle)"
        stroke="#0f172a"
        strokeWidth="1"
      />
      <polygon
        points="22,44 35,22 48,44"
        fill="url(#roofGradCastle)"
        stroke="#ca8a04"
        strokeWidth="1"
      />
      ...
      <path
        d="M 70,94 L 70,72 A 10 10 0 0 1 90 72 L 90,94 Z"
        fill="#78350f"
        stroke="#f59e0b"
        strokeWidth="1.5"
      />
