...
export const ICON_ASSETS = {
  ...
  filter: "/assets/icons/icon_settings_european.png",
  chart: "/assets/icons/icon_report.png",
  ...
  settings: "/assets/icons/icon_settings_european.png",
  ...
  event: "/assets/icons/icon_event.png",
