  ...
  return (
    <svg viewBox="0 0 100 100" width="46" height="46" style={{ flexShrink: 0, filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.6))" }}>
      <defs>
        ...
        <linearGradient id="royalBlueShieldGradModal" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#3b82f6" />
          <stop offset="100%" stopColor="#1d4ed8" />
        </linearGradient>
      </defs>

      <circle cx="50" cy="50" r="41" fill="url(#circleDarkBgModal)" stroke="url(#goldRingGradModal)" strokeWidth="3" />
      ...
      <circle cx="36" cy="46" r="7.5" fill="url(#knightSteelGradModal)" stroke="url(#goldRingGradModal)" strokeWidth="1" />
      <circle cx="64" cy="46" r="7.5" fill="url(#knightSteelGradModal)" stroke="url(#goldRingGradModal)" strokeWidth="1" />

      <rect x="41" y="24" width="18" height="20" rx="4" fill="url(#knightSteelGradModal)" stroke="url(#goldRingGradModal)" strokeWidth="1.5" />
      <rect x="43" y="31" width="14" height="3" fill="#020617" />
      <rect x="49" y="34" width="2.5" height="7" fill="#020617" />

      <path d="M 54,46 L 78,46 C 78,46 80,72 66,84 C 52,72 54,46 54,46 Z" fill="url(#royalBlueShieldGradModal)" stroke="url(#goldRingGradModal)" strokeWidth="2" />
      <rect x="63" y="50" width="6" height="26" fill="url(#goldRingGradModal)" />
      <rect x="56" y="60" width="20" height="6" fill="url(#goldRingGradModal)" />
    </svg>
  );
}
...
function CavalryAvatar() {
  return (
    <svg viewBox="0 0 100 100" width="46" height="46" style={{ flexShrink: 0, filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.6))" }}>
      ...
      <circle cx="50" cy="50" r="41" fill="url(#circleDarkBgCavalryModal)" stroke="url(#goldLanceGradModal)" strokeWidth="3" />
      <circle cx="50" cy="50" r="37.5" fill="none" stroke="rgba(254,240,138,0.4)" strokeWidth="1.2" />
      ...
      <path d="M 43,46 Q 34,22 20,28 Q 12,35 24,50 Z" fill="url(#horseBrownGradModal)" />
      <path d="M 34,22 Q 38,34 42,44" stroke="#1c1917" strokeWidth="4" fill="none" strokeLinecap="round" />

      <path d="M 36,54 Q 53,50 70,56 Q 66,74 40,72 Z" fill="#1d4ed8" stroke="url(#goldLanceGradModal)" strokeWidth="1.5" />

      <circle cx="52" cy="32" r="7.5" fill="#64748b" stroke="url(#goldLanceGradModal)" strokeWidth="1" />
      <path d="M 44,39 L 60,39 L 62,55 L 42,55 Z" fill="#475569" />

      <line x1="8" y1="58" x2="94" y2="16" stroke="url(#goldLanceGradModal)" strokeWidth="4" strokeLinecap="round" />
...
function ArtilleryAvatar() {
  return (
    <svg viewBox="0 0 100 100" width="46" height="46" style={{ flexShrink: 0, filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.6))" }}>
      <defs>
        <radialGradient id="circleDarkBgArtilleryModal" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#1e3a5f" />
          <stop offset="80%" stopColor="#0b1422" />
          <stop offset="100%" stopColor="#040810" />
        </radialGradient>
      ...
      <circle cx="50" cy="50" r="41" fill="url(#circleDarkBgArtilleryModal)" stroke="url(#bronzeCannonGradModal)" strokeWidth="3" />
      <circle cx="50" cy="50" r="37.5" fill="none" stroke="rgba(254,240,138,0.4)" strokeWidth="1.2" />
      ...
      <g transform="rotate(-16, 50, 50)">
        <polygon points="26,38 78,34 78,54 26,50" fill="url(#bronzeCannonGradModal)" stroke="#78350f" strokeWidth="1.5" />
        <ellipse cx="26" cy="44" rx="4" ry="7" fill="#1c1917" stroke="url(#bronzeCannonGradModal)" strokeWidth="1.5" />
        <rect x="74" y="32" width="6" height="24" rx="2" fill="url(#bronzeCannonGradModal)" stroke="#78350f" strokeWidth="1" />
      </g>

      <circle cx="34" cy="68" r="12" fill="url(#bronzeCannonGradModal)" stroke="#451a03" strokeWidth="2" />
      <circle cx="34" cy="68" r="4" fill="#1c1917" />
      <circle cx="66" cy="68" r="12" fill="url(#bronzeCannonGradModal)" stroke="#451a03" strokeWidth="2" />
...
const CastleThumbnail = () => (
  <svg viewBox="0 0 160 100" width="125" height="75" style={{ borderRadius: 6, border: "1px solid rgba(184, 147, 68, 0.4)", flexShrink: 0 }}>
    ...
    <rect x="25" y="40" width="22" height="45" fill="#334155" stroke="#0f172a" strokeWidth="1.5" />
    <polygon points="25,40 36,25 47,40" fill="#2563eb" />
    <rect x="113" y="40" width="22" height="45" fill="#334155" stroke="#0f172a" strokeWidth="1.5" />
...
export function TroopDeploymentModal({
  ...
  return (
    <div className="ob-modal-overlay" onMouseDown={onClose}>
      <div className="ob-modal-container town-modal attack-dispatch-modal" onMouseDown={(e) => e.stopPropagation()}>
        ...
        <div className="rt-army-overview-grid">
          <div className="rt-army-stat-card">
            <span className="label"><HelmetIconSVG /> QUÂN TRONG THÀNH</span>
          ...
          <div className="rt-army-stat-card">
            <span className="label"><ShieldIconSVG /> BÌNH LÍNH Ở LẠI THỦ THÀNH</span>
            <span className="val text-gold">{unitsRemaining} quân</span>
          </div>
          <div className="rt-army-stat-card">
            <span className="label"><HorseHeadSVG /> BÌNH LÍNH HÀNH QUÂN</span>
            <span className="val text-gold">{currentUnitsSent} quân</span>
          </div>
          <div className="rt-army-stat-card">
            <span className="label"><TargetIconSVG /> SỨC MẠNH XUẤT CHIẾN</span>
            <span className="val text-gold">{currentPowerSent}</span>
          </div>
          <div className="rt-army-stat-card">
            <span className="label"><ScalesIconSVG /> TẢI TRỌNG HÀNH QUÂN</span>
            <span className="val text-gold">{currentUnitsSent * 23} / {totalUnitsAvailable * 100}</span>
          </div>
        </div>
        ...
        <div className="rt-dispatch-section margin-top">
          ...
          <div className="rt-troop-slider-row">
            ...
            <div className="rt-slider-content">
              <div className="rt-slider-header">
                <span className="unit-name blue">Bộ binh ({config.infantrySpeed} km/h)</span>
                <span className="unit-count">{infantry} / {maxInfantry} sĩ</span>
              </div>
          ...
          <div className="rt-troop-slider-row">
            ...
            <div className="rt-slider-content">
              <div className="rt-slider-header">
                <span className="unit-name green">Kị binh ({config.cavalrySpeed} km/h)</span>
                <span className="unit-count">{cavalry} / {maxCavalry} sĩ</span>
              </div>
              <div className="rt-slider-track-box">
                <input
                  type="range"
          ...
          <div className="rt-troop-slider-row">
            ...
            <div className="rt-slider-content">
              <div className="rt-slider-header">
                <span className="unit-name red">Pháo binh ({config.artillerySpeed} km/h)</span>
                <span className="unit-count">{artillery} / {maxArtillery} sĩ</span>
              </div>
              <div className="rt-slider-track-box">
                <input
                  type="range"
        ...
        <div className="rt-march-time-row">
          <div className="time-card">
            <span className="label"><HourglassIcon /> THỜI GIAN HÀNH QUÂN</span>
            <span className="val text-gold">{travelText}</span>
          </div>
          <div className="info-card">
            <div className="info-line">Khoảng cách: {distanceKm} km &nbsp;|&nbsp; Tốc độ hiệu dụng: {marchSpeed} km/h &nbsp;|&nbsp; Chậm nhất: {slowestUnit}.</div>
            <div className="info-sub">&gt; Nếu vượt biển sẽ dùng thuyền (12 km/h), 1 giờ game = 60 giây thật.</div>
          </div>
        </div>
